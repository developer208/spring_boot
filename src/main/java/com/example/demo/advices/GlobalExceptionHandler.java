...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> argumentNotValidException(MethodArgumentNotValidException exception) {
        ...
        ApiError apiError = ApiError.builder().status(HttpStatus.BAD_REQUEST).message("Input Validation Errors").subErrors(errors).build();
        return buildErrorResponseEntity(apiError);
    }
